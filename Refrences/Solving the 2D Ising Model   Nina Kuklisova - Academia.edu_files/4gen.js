  ...
  *******************************************************************************************/
  ...
  var DocumentManager = (function () {
      ...
      ScrollViewManager.prototype._gotoPage = function(pageId, options) {
        ...
        var eligible_for_pretty_scrolling = typeof($) !== "undefined" && typeof($.scrollTo) !== 'undefined';
        ...
        if (options.pretty && eligible_for_pretty_scrolling) {
          ...
          if (options.offset) {
            boundingRectToScrollTo.top -= options.offset;
          }
      ...
      ScrollViewManager.prototype.pagePosition = function() {
        // remember where in the current page we are
        var page = this.documentManager.currentPageNum() || 1;
        var page_elm = $("#outer_page_" + page);

        //DEV-934
        //using a default pos and checking for elm length
        var pos = 0;
        if (page_elm.length){
      ...
      // restores a position from pagePosition, [page_num, percentage_of_page]
      ...
      DocumentManager.prototype.doDynamicBlurring = function (pageId) {
        ...
        if (!this.removeInsteadOfBlurring()) {
          ...
          $(document).ready(function () {
            ...
            promo = $('#grab_blur_promo_here').contents().clone()
